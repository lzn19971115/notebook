- [一、数据类型](#一数据类型)
  - [1. 基础数据类型](#1-基础数据类型)
  - [2. 引用类型](#2-引用类型)
  - [3. 封装基础数据类型](#3-封装基础数据类型)
    - [封装类和基础数据类型的区别](#封装类和基础数据类型的区别)
- [二、面向对象](#二面向对象)
  - [1. 三大特征](#1-三大特征)
    - [1）封装](#1封装)
    - [2）继承](#2继承)
    - [3）多态](#3多态)
- [三、抽象类和接口](#三抽象类和接口)
  - [1.抽象类，abstract](#1抽象类abstract)
    - [注意：](#注意)
  - [2.接口，interface](#2接口interface)
    - [注意：](#注意-1)
- [四、重写和重载](#四重写和重载)
  - [1.重写](#1重写)
  - [2.重载](#2重载)
- [五、final关键字](#五final关键字)
- [六、static关键字](#六static关键字)
- [七、局部变量，静态变量，成员变量](#七局部变量静态变量成员变量)
- [八、字符串](#八字符串)
- [九、访问修饰符](#九访问修饰符)
- [十、java是值传递，还是地址传递](#十java是值传递还是地址传递)
- [十一、深拷贝和浅拷贝](#十一深拷贝和浅拷贝)
  - [1.定义](#1定义)
  - [2.内存](#2内存)
- [十二、异常](#十二异常)
  - [1.概述](#1概述)
  - [2.分类](#2分类)
  - [3.Exception分类](#3exception分类)
    - [3.1运行时异常](#31运行时异常)
    - [3.1非运行时异常（编译异常）](#31非运行时异常编译异常)
- [十三、反射](#十三反射)
